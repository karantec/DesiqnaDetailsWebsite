...
const stories = [
  {
    ...
    experience: "From college student to 2Cr package in just 8 months!",
  ...
  },
  {
    ...
    experience: "Career switch from non-tech to top fintech company",
  ...
  },
  {
    ...
    experience: "Consulting dream achieved with strategic preparation",
  ...
  },
  {
    ...
    studentName: "Sarah Gupta",
    role: "Software Engineer",
    experience: "Professional network builder becomes network engineer!",
  ...
  },
  {
    ...
    experience: "From local startup to global tech giant",
  ...
  },
  {
    ...
    role: "iOS Developer",
    experience: "Think different, code different, earn different",
  ...
  },
  {
    ...
    role: "SDE-2",
    experience: "Delivered excellence, just like Amazon packages",
    tags: ["E-commerce", "Distributed Systems", "AWS"]
  },
  {
    company: "Google",
    package: "₹60 LPA",
    ...
    role: "Software Engineer",
    experience: "Searched for success, found it at Google!",
    tags: ["Search", "ML", "Algorithms"]
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Meet our incredible students who turned their coding dreams into reality. 
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 max-w-4xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-green-600 mb-1">₹2Cr+</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-600 mb-1">FAANG</div>
          ...
          {stories.map((story, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {/* Package */}
                <div className="mb-4">
                  <div className="text-3xl font-bold mb-1">{story.package}</div>
                  <div className="text-sm opacity-90">{story.role}</div>
                </div>

                {/* Student Info */}
                <div className="mb-4">
                  <div className="font-semibold text-lg">{story.studentName}</div>
                  <div className="text-sm opacity-90 leading-relaxed">{story.experience}</div>
                </div>
                ...
                {/* Video Thumbnail */}
                <div className="rounded-lg overflow-hidden bg-black/20 aspect-video flex items-center justify-center group-hover:bg-black/30 transition-colors">
                  <div 
                    className="flex items-center gap-2 text-white font-semibold hover:scale-110 transition-transform"
                    onClick={(e) => {
                      e.stopPropagation();
        ...
        <div className="text-center">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-white/50 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">Join thousands of students who transformed their careers with us.</p>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="text-2xl font-bold text-gray-800">{selectedStory.studentName}</h3>
                <p className="text-gray-600">{selectedStory.company} • {selectedStory.package}</p>
              </div>
              <button
            ...
            <div className="mt-4">
              <p className="text-gray-700 mb-4">{selectedStory.experience}</p>
